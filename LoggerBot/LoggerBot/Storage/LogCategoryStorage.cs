...
namespace LoggerBot.Storage
{
    ...
    public class LogCategoryStorage : ILogCategoryStorage
    {
        ...
        public LogCategoryStorage(Uri serviceEndpoint, string authKey, string databaseId, string collectionId, Action<ConnectionPolicy> connectionPolicyConfigurator = null)
        {
