using System;
using LoggerBot.Handlers.Message;
using LoggerBot.Middleware;
...
namespace LoggerBot
{
    public class Startup
    {
        ...
        public Startup(IHostingEnvironment env)
        {
            ...
            // Set credentials so bot can easily access them in other places
            ...
            LoggerBot.MicrosoftAppCredentials = new MicrosoftAppCredentials(microsoftAppId, microsoftAppPassword);
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddBot<LoggerBot>(options =>
            {
                ...
                options.Middleware.Add(new ShowTypingMiddleware(delay: 1));
                ...
                ////IStorage dataStore = new CosmosDbStorage();

                ////options.Middleware.Add(new ConversationState<EchoState>(dataStore));
                options.Middleware.Add(new UserState<LoggerBotUserState>(dataStore));

                options.Middleware.Add(new LogCategoriesMiddleware());
            });
        }
